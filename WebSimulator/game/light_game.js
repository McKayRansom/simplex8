...
//
//	General ui functionality shared by various screens
//

rat.modules.add( "js.ui.ui", [], function(rat)
{
	...
	var ui = {
		...
		menus : {
			...
			buttonFont: {font:'banksia_bold', style:'bold', size:80, color:new rat.graphics.Color(77, 40, 0)},
			titleFont: {
				font:'ceviche_oneregular', style:'', size:196, color:new rat.graphics.Color(175, 188, 255),
				stroke: {width:8, color:new rat.graphics.Color(0, 12, 72), doCleanup:false},
				},
			headingFont: {font:'banksia_bold', style:'bold', size:46, color:new rat.graphics.Color(255, 186, 112)},
			mainFont: {font:'banksia_bold', style:'', size:56, color:new rat.graphics.Color(175, 188, 255)},	//	normal text
			
			tipFont: {font:'banksia_bold', style:'', size:36, color:new rat.graphics.Color(220, 220, 200)},	//	normal text
...
//	mouse down in me
//	pass on to game.
GameScreen.prototype.mouseDown = function(pos)
{
...
//	mouse up in me
//	pass on to game.
GameScreen.prototype.mouseUp = function(pos)
{
	game.mouseUp(pos);
};
...
//	mouse move in me
//	pass on to game.
GameScreen.prototype.mouseMove = function(pos)
{
	game.mouseMove(pos);
};
