...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-38428-leftserv/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog {
      ./.Xil/Vivado-38428-leftserv/realtime/clk_wiz_0_stub.v
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-38428-leftserv/"
    if {$rt::useElabCache == false} {
